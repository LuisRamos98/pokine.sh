...
alias crackmapexec='sudo poetry run crackmapexec'
# Custom Aliases
# -----------------------------------------------
# bat
alias cat='batcat'
...
if [ -f $HOME/.oh-my-zsh/plugins/sudo/sudo.plugin.zsh ]; then
	source $HOME/.oh-my-zsh/plugins/sudo/sudo.plugin.zsh
fi

if [ -f /usr/share/zsh-fzf-history-search/zsh-fzf-history-search.zsh ]; then
  source /usr/share/zsh-fzf-history-search/zsh-fzf-history-search.zsh
fi 
...
echo -en "\e]2;Kitty Terminal\a"
preexec () { print -Pn "\e]0;$1 - Kitty Terminal\a" }
